...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto p-6">
        ...
        <?php if (isset($_SESSION['message'])): ?>
            <div class="mb-2 p-2 rounded text-sm <?= $_SESSION['message_type'] === 'success' ? 'bg-green-100 text-green-700 border border-green-300' : 'bg-red-100 text-red-700 border border-red-300' ?>">
                <?= $_SESSION['message'] ?>
            </div>
        ...
        <div id="content-empleados" class="tab-content <?= $tabActiva !== 'empleados' ? 'hidden' : '' ?>">
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    ...
                    <form method="POST" action="index.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" name="salario" step="0.01" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Departamento</label>
                            <select name="departamento" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    ...
                    <?php if (!empty($datosEmpleados['departamento_mayor_promedio'])): ?>
                        <div class="mb-2 p-2 bg-green-50 border border-green-200 rounded">
                            <h3 class="font-medium text-green-800 text-sm">Departamento con Mayor Promedio</h3>
            ...
            <!-- Lista de empleados -->
            <div class="mt-2 bg-white p-3 rounded-lg shadow">
                <h2 class="text-lg font-semibold mb-2">Todos los Empleados</h2>
        ...
        <div id="content-ventas" class="tab-content <?= $tabActiva !== 'ventas' ? 'hidden' : '' ?>">
            <div class="grid md:grid-cols-2 gap-3">
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    <h2 class="text-lg font-semibold mb-2">Agregar Venta</h2>
                    <form method="POST" action="index.php">
                        <input type="hidden" name="action" value="add_venta">
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Cliente</label>
                            <input type="text" name="cliente" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Producto</label>
                            <input type="text" name="producto" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Cantidad</label>
                            <input type="number" name="cantidad" min="1" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Precio Unitario</label>
                            <input type="number" name="precio_unitario" step="0.01" min="0.01" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Fecha de Venta</label>
                            <input type="date" name="fecha_venta" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <button type="submit" class="w-full bg-green-600 text-white py-1.5 px-3 text-sm rounded-md hover:bg-green-700 focus:outline-none focus:ring-1 focus:ring-green-500">
                            Agregar Venta
                        </button>
                    </form>
                </div>
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    <h2 class="text-lg font-semibold mb-2">Estadísticas de Ventas</h2>
                    
                    <div class="space-y-2">
                        <div class="p-2 bg-blue-50 border border-blue-200 rounded">
                            <h3 class="font-medium text-blue-800 text-sm">Total de Ventas</h3>
                            <p class="text-lg font-bold text-blue-700"><?= $datosVentas['total_ventas'] ?></p>
                        </div>

                        <?php if (!empty($datosVentas['cliente_mas_gasto'])): ?>
                            <div class="p-2 bg-green-50 border border-green-200 rounded">
                                <h3 class="font-medium text-green-800 text-sm">Cliente que Más Gastó</h3>
                                <p class="text-green-700 text-sm">
                    ...
                    <div class="mt-2">
                        <a href="index.php?action=generar_pdf" target="_blank" class="w-full block text-center bg-red-600 text-white py-1.5 px-3 text-sm rounded-md hover:bg-red-700 focus:outline-none focus:ring-1 focus:ring-red-500">
            ...
            <!-- Lista de ventas -->
            <div class="mt-2 bg-white p-3 rounded-lg shadow">
                <h2 class="text-lg font-semibold mb-2">Últimas Ventas</h2>
                <div class="overflow-x-auto">
        ...
        <div id="content-calculadoras" class="tab-content <?= $tabActiva !== 'calculadoras' ? 'hidden' : '' ?>">
            <div class="grid md:grid-cols-2 gap-3">
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    <h2 class="text-base font-semibold mb-2">Calculadora de Salario Neto (Colombia)</h2>
                    <form method="POST" action="index.php">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" name="salario_bruto" step="0.01" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">
                        </div>
                        <button type="submit" class="w-full bg-blue-600 text-white py-1.5 px-3 text-sm rounded-md hover:bg-blue-700">
                            Calcular
                        </button>
                    </form>
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    <h2 class="text-base font-semibold mb-2">Calculadora de Interés Compuesto</h2>
                    <form method="POST" action="index.php">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" name="capital" step="0.01" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tasa de Interés Anual (%)</label>
                            <input type="number" name="tasa" step="0.01" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tiempo (años)</label>
                            <input type="number" name="tiempo" step="0.1" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Períodos por Año</label>
                            <select name="periodos" class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500">
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    <h2 class="text-base font-semibold mb-2">Convertidor de Temperatura</h2>
                    <form method="POST" action="index.php">
                        <input type="hidden" name="action" value="convertir_temperatura">
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Valor</label>
                            <input type="number" name="valor_temp" step="0.01" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-purple-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">De:</label>
                            <select name="origen_temp" class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-purple-500">
                        ...
                        <div class="mb-2">
                            ...
                            <select name="destino_temp" class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-purple-500">
                                <option value="F">Fahrenheit (°F)</option>
                                <option value="C">Celsius (°C)</option>
                                <option value="K">Kelvin (K)</option>
                            </select>
                        </div>
                        <button type="submit" class="w-full bg-purple-600 text-white py-1.5 px-3 text-sm rounded-md hover:bg-purple-700">
                            Convertir
                        </button>
                    </form>
                ...
                <div class="bg-white p-3 rounded-lg shadow">
                    <h2 class="text-base font-semibold mb-2">Convertidor de Velocidad</h2>
                    <form method="POST" action="index.php">
                        <input type="hidden" name="action" value="convertir_velocidad">
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Valor</label>
                            <input type="number" name="valor_vel" step="0.01" min="0" required class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500">
                        </div>
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">De:</label>
                            <select name="origen_vel" class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500">
                        ...
                        <div class="mb-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">A:</label>
                            <select name="destino_vel" class="w-full px-2 py-1 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-orange-500">
                                <option value="km/h">Kilómetros por hora (km/h)</option>
                                <option value="m/s">Metros por segundo (m/s)</option>
                                <option value="mph">Millas por hora (mph)</option>
                            </select>
                        </div>
                        <button type="submit" class="w-full bg-orange-600 text-white py-1.5 px-3 text-sm rounded-md hover:bg-orange-700">
                            Convertir
                        </button>
                    </form>
